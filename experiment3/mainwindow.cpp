...
void MainWindow::on_pushButton0_clicked()//按下0按钮
{
    ...
    QString str;
    for(QVector<QString>::iterator it=strVec.begin();it!=strVec.end();it++)//迭代器开始
        str+=*it;
...
void MainWindow::on_pushButtonC_clicked()//按下Clean按钮
{
    /*将所有栈清空*/
    this->signalInputFlag=false;
    strVec.clear();
...
void MainWindow::on_pushButtonBackspace_clicked()//按下Del按钮
{
